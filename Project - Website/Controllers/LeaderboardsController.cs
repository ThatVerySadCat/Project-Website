...
namespace Project___Website.Controllers
{
    public class LeaderboardsController : Controller
    {
        ...
        public ActionResult Leaderboards()
        {
            ...
            viewModel.GlobalLeaderboardEntries.Add(new LeaderboardEntryViewModel(1, 100, "User 1"));
            viewModel.GlobalLeaderboardEntries.Add(new LeaderboardEntryViewModel(2, 50, "User 2"));
            viewModel.GlobalLeaderboardEntries.Add(new LeaderboardEntryViewModel(3, 25, "User 3"));
            viewModel.GlobalLeaderboardEntries.Add(new LeaderboardEntryViewModel(4, 12, "User 4"));
            viewModel.GlobalLeaderboardEntries.Add(new LeaderboardEntryViewModel(5, 6, "User 5"));
            viewModel.GlobalLeaderboardEntries.Add(new LeaderboardEntryViewModel(6, 5, "User 1"));
            viewModel.GlobalLeaderboardEntries.Add(new LeaderboardEntryViewModel(7, 4, "User 1"));
            viewModel.GlobalLeaderboardEntries.Add(new LeaderboardEntryViewModel(8, 3, "User 1"));
